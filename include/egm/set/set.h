...
namespace EGM {
    ...
    class SetDataPolicy : virtual public AbstractSet {
        protected:
            ...
            class iterator : public AbstractSet::iterator {
                ...
                private:
                    ...
                    typename std::unordered_map<ID, ManagedPtr<ManagedType>>::const_iterator m_dataIt;
     ...
     protected:
            ...
            bool containsData(ManagedPtr<ManagedType> ptr) const {
                return m_data.count(ptr.id()) > 0;
            }
            void addData(ManagedPtr<ManagedType> ptr) {
                if (!ptr) {
            ...
            bool removeData(ManagedPtr<ManagedType> ptr) {
        ...
        public:
            ...
            ManagedPtr<ManagedType> front() const {
                ...
                if (!m_structure->m_subSetsWithData.empty()) {
                    return ManagedPtr<ManagedType>((*m_structure->m_subSetsWithData.begin())->m_set.beginPtr()->getCurr());
                }
                return ManagedPtr<ManagedType>();
            }
    ...
    class Set : public ReadOnlySet<T, U, ApiPolicy> , public AbstractReadableSet {
        public:
            using ManagedType = typename ReadOnlySet<T, U, ApiPolicy>::ManagedType;
            ...
            void remove(ID& id) {
                this->innerRemove(ManagedPtr<ManagedType>(id));
            }
