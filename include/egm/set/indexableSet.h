...
namespace EGM {
    ...
    class IndexablePolicy : public DoNothingPolicy , virtual public AbstractSet {
        using NamedElementPtr = ManagedPtr<NamedElement<typename ManagerPolicy::Manager::template GenBaseHierarchy<NamedElement>>>;
        public:
    ...
    class ReadOnlyIndexableSet : public ReadOnlySet<T, U, ApiPolicy> {
        ...
        public:
            ...
            ManagedPtr<ManagedType> get(std::string name) const {
